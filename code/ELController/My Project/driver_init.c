...
void EXTERNAL_IRQ_0_init(void)
{
	...
	gpio_set_pin_function(BTN_UP, PINMUX_PB06A_EIC_EXTINT6);
	...
	gpio_set_pin_function(BTN_DOWN, PINMUX_PB07A_EIC_EXTINT7);

	// Set pin direction to input
	gpio_set_pin_direction(BTN_ENTER, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(BTN_ENTER,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(BTN_ENTER, PINMUX_PB12A_EIC_EXTINT12);

	// Set pin direction to input
	gpio_set_pin_direction(BTN_EXIT, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(BTN_EXIT,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
...
void SPI_0_PORT_init(void)
{
	...
	gpio_set_pin_function(DISPLAY_MOSI, PINMUX_PA12D_SERCOM4_PAD0);
	...
	gpio_set_pin_function(DISPLAY_SCK, PINMUX_PA13D_SERCOM4_PAD1);
...
void system_init(void)
{
	...
	gpio_set_pin_function(PWR_GOOD, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA09

	gpio_set_pin_level(OUTPUT_ENABLE,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(MIC_ENABLE, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(MIC_ENABLE, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA19

	// Set pin direction to input
	gpio_set_pin_direction(I2S_SD, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(I2S_SD,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(I2S_SD, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA20

	// Set pin direction to input
	gpio_set_pin_direction(I2S_SCK, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(I2S_SCK,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(I2S_SCK, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA21

	// Set pin direction to input
	gpio_set_pin_direction(I2S_WS, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(I2S_WS,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(I2S_WS, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA24

	// Set pin direction to input
	gpio_set_pin_direction(USB_DM, GPIO_DIRECTION_IN);
	...
	gpio_set_pin_function(USB_DM, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA25

	// Set pin direction to input
	gpio_set_pin_direction(USB_DP, GPIO_DIRECTION_IN);
	...
	gpio_set_pin_function(USB_DP, GPIO_PIN_FUNCTION_OFF);
	...
	gpio_set_pin_level(DMX_SENDER_ENABLE,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(DMX_SENDER_ENABLE, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(DMX_SENDER_ENABLE, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PB04

	// Set pin direction to input
	gpio_set_pin_direction(USB_CC1, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(USB_CC1,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(USB_CC1, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PB05

	// Set pin direction to input
	gpio_set_pin_direction(USB_CC2, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(USB_CC2,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(USB_CC2, GPIO_PIN_FUNCTION_OFF);
